...
public class Level7 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(Input.GetMouseButton(0) && _countMultiplier != _cachedMultiplier) 
        {
    ...
    private void UpdateBuffers()
    {
        ...
        var position1 = new Vector4[_count];
        var position2 = new Vector4[_count];
        ...
        for (int i = 0; i < _count; i++)
        {
            ...
            position1[i] = dir * Random.Range(10, 15) + offset;
            position2[i] = dir * Random.Range(30, 50) + offset;

            position1[i].w = Random.Range(-3f, 3f);
            position2[i].w = batch;
        ...
        _positionBuffer1.SetData(position1);
        _positionBuffer2.SetData(position2);
